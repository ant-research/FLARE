...
torchrun --nproc_per_node=1 --master_port=1223 test_dtu.py --test_dataset "DTU(split='train',ROOT='/nas3/zsz/dtu', resolution=(512,384), seed=772343247, num_views=25, gt_num_image=0, aug_portrait_or_landscape=False)"   --test_criterion "TriangulationMetric(L21)" \
...
--output_dir "checkpoints/dtu" --seed 2  --noise_rot 0  --noise_trans 0. --noise_prob 0.5 --num_workers 0 --amp 1 
