...
class Re10K(BaseStereoViewDataset):
    ...
    def _get_views(self, idx, resolution, rng):
        ...
        frames, w2c_mats, Ks, clip_path = self._sequential_index(rng)
        views = []
...
if __name__ == "__main__":
    ...
    dataset = Re10K(split='train', ROOT="/nas3/zsz/RealEstate10k_v2/",meta='/nas3/zsz/RealEstate10k_v2/annotations/train.json',resolution=[(512, 384)], aug_crop=16)
