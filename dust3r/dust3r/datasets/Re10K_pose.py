...
# json_train_path = '/nas3/zsz/RealEstate10k_v2/annotations/train.json'
# json_test_path = '/nas3/zsz/RealEstate10k_v2/annotations/train.json'
# json_val_path = '/nas3/zsz/RealEstate10k_v2/annotations/validation.json'
...
class Re10K_pose(BaseStereoViewDataset_test):
    ...
    def _sequential_index(self, scene, video_path, rng):
        ...
        im_list = [i * interal for i in range(5)]
