...
class DTU_num(BaseStereoViewDataset_test):
    ...
    def build_list(self):
        ...
        for scan in scans:
            ...
            with open(os.path.join(self.datapath, pair_file)) as f:
                ...
                interal = num_viewpoint // 3
                interal_true = num_viewpoint // self.nviews
                ref_view = num_viewpoint
                # step = num_viewpoint // 7
                src_views = list(range(num_viewpoint))[::interal][:2] + list(range(num_viewpoint))[::interal_true][:self.nviews-2]
